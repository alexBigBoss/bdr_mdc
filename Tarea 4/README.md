...
1. Crea una base de datos y tablas correspondientes a partir de tus tareas de los modelos e-r y relacional
2. Incluye al menos 20 registros en tu base de datos.
3. Sube tu archivo de creación de base de datos a tu repositorio con tu nombre claro en formato sql.
4. Tu archivo se ejecuta completamente y sin ningún error en su SGDB correspondiente
